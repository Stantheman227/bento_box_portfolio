          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1">
                <p className="truncate font-display text-base leading-[1] text-white transition-colors duration-200 group-hover/proj:text-white/80">
                  {project.title}
                </p>
              ...
              <p className="truncate font-mono text-[9px] uppercase tracking-wide text-white/40 lg:text-[8px]">
                {project.tech}
              </p>
            </div>

            {/* Tag */}
            <span className="shrink-0 font-mono text-[8px] uppercase tracking-wide text-white/30">
              {project.tag}
            </span>
          </a>
        ))}
